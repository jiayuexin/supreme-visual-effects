  ...
  <div class="playground">
    ...
    <main>
      ...
      <section>
        ...
        <div class="demo-container">
          ...
          <VParallax :layers="parallaxLayers" :enabled="true" class="parallax-demo">
            ...
            <template #layer-1>
              <div class="parallax-mid">Middle Layer</div>
            </template>
            <template #layer-2>
              <div class="parallax-fg">Foreground Layer</div>
            </template>
          </VParallax>
        </div>
      ...
      <section>
        ...
        <div class="demo-container">
          <h3>VScrollReveal Component</h3>
          <p>Scroll down to see the effect.</p>
        </div>

        <VScrollReveal v-for="n in 5" :key="n" class="box-container">
          <div class="box">
            <p>Item {{ n }}</p>
          </div>
        </VScrollReveal>
