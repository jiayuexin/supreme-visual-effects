...
| 测试 | `vitest`, `jsdom`, `@storybook/vue3` |
...
## 🗺️ 开发计划
1. **v0.1**：核心插件 & 基础组件 (Ripple / ScrollReveal)
2. **v0.2**：粒子/背景系组件 + 全局主题系统
3. **v0.3**：3D Carousel、ImageComparison 等高级组件
4. **v1.0**：稳定发布，完善文档与 CI/CD
